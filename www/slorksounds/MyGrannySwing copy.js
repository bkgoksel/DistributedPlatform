...
define(
 ["jsaSound/jsaModels/NewGrannySwingDistributed"],
...
function(sndFactory){
  return function(cb){
    return sndFactory(function(snd){
        ...
        snd.setParam("play", 0);
        snd.setParam("Pitch", -1);
        snd.setParam("Randomize Pitch", 0.47);
        snd.setParam("Grain Size", 0.9);
        snd.setParam("Step Size", 0.02);
        snd.setParam("Grain Play Interval", 0.26);
